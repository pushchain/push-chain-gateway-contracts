...
/**
 * @title UpgradeUniversalGateway
 * @notice Upgrade UniversalGateway proxy to new implementation
 */
contract UpgradeUniversalGateway is Script {
    ...
    function run() external {
        ...
        console.log("=== UPGRADING UNIVERSAL GATEWAY ON %s ===", network);
    ...
    function _loadConfig() internal view {
    ...
    function _deployNewImplementation() internal {
        ...
        UniversalGateway newImpl = new UniversalGateway();
