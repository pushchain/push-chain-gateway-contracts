...
contract GatewayExecuteUniversalTxTest is Test {
    ...
    function setUp() public {
        ...
        token.mint(address(gateway), 100000e18);
        usdtToken.mint(address(gateway), 100000e18);
        approvalToken.mint(address(gateway), 100000e18);
    ...
    function testExecuteUniversalTx_NativePath_Success() public {
        ...
        vm.prank(tss);
        gateway.executeUniversalTx{value: AMOUNT}(TX_ID, ORIGIN_CALLER, ZERO_ADDRESS, address(target), AMOUNT, PAYLOAD);
    ...
    function testExecuteUniversalTx_NativePath_WrongValue_Reverts() public {
        ...
        vm.prank(tss);
        vm.expectRevert(abi.encodeWithSelector(Errors.InvalidAmount.selector));
        gateway.executeUniversalTx{value: AMOUNT - 1}(TX_ID, ORIGIN_CALLER, ZERO_ADDRESS, address(target), AMOUNT, PAYLOAD);
    ...
    function testExecuteUniversalTx_NativePath_NonPayableTarget_Reverts() public {
        ...
        gateway.executeUniversalTx{value: AMOUNT}(TX_ID, ORIGIN_CALLER, ZERO_ADDRESS, address(revertingTarget), AMOUNT, nonPayablePayload);
    }
    ...
    function testExecuteUniversalTx_NativePath_TargetReverts_Reverts() public {
        ...
        vm.prank(tss);
        vm.expectRevert(abi.encodeWithSelector(Errors.ExecutionFailed.selector));
        gateway.executeUniversalTx{value: AMOUNT}(TX_ID, ORIGIN_CALLER, ZERO_ADDRESS, address(revertingTarget), AMOUNT, PAYLOAD);
    ...
    function testExecuteUniversalTx_NativePath_GasExhaustion_Reverts() public {
        ...
        vm.prank(tss);
        vm.expectRevert(abi.encodeWithSelector(Errors.ExecutionFailed.selector));
        gateway.executeUniversalTx{value: AMOUNT, gas: 3000000}(TX_ID, ORIGIN_CALLER, ZERO_ADDRESS, address(revertingTarget), AMOUNT, gasHeavyPayload);
