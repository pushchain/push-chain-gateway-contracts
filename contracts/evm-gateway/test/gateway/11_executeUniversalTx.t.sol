...
contract GatewayExecuteUniversalTxTest is Test {
    ...
    // Note: UniversalTxExecuted event and executeUniversalTx functions have been removed
    // from UniversalGateway.sol as part of CEA-only execution architecture
    ...
    // =========================
    //   executeUniversalTx Tests - REMOVED (CEA-only execution architecture)
    // =========================
    // Note: All executeUniversalTx functions have been removed from UniversalGateway.sol
    // Outbound execution now flows exclusively through Vault -> CEA -> Target
    // These tests are commented out as the functionality no longer exists in the gateway
    ...
    //     gateway.executeUniversalTx{ value: AMOUNT }(TX_ID, ORIGIN_CALLER, address(revertingTarget), AMOUNT, nonPayablePayload);
    // }
    ...
    //     vm.expectRevert(abi.encodeWithSelector(Errors.ExecutionFailed.selector));
    //     gateway.executeUniversalTx{ value: AMOUNT, gas: 3000000 }(TX_ID, ORIGIN_CALLER, address(revertingTarget), AMOUNT, gasHeavyPayload);
    //     assertFalse(gateway.isExecuted(TX_ID));
    // }
    ...
    //     bytes memory tokenPayload = abi.encodeWithSignature("receiveToken(address,uint256)", address(approvalToken), AMOUNT);
    //     vm.expectRevert(abi.encodeWithSelector(Errors.InvalidData.selector));
    ...
    // =========================
    //   _resetApproval Tests - REMOVED (helper function deleted)
    // =========================
    ...
    // =========================
    //   _safeApprove Tests - REMOVED (helper function deleted)
    // =========================
    ...
    //     bytes memory tokenPayload = abi.encodeWithSignature("receiveToken(address,uint256)", address(mockUsdtToken), AMOUNT);
    //     vm.startPrank(address(gateway));
    ...
    // =========================
    //   _executeCall Tests - REMOVED (helper function deleted)
    // =========================
    ...
    //     token.transfer(address(gateway), AMOUNT);
    //     vm.expectRevert(abi.encodeWithSelector(Errors.ExecutionFailed.selector));
    //     gateway.executeUniversalTx(TX_ID, ORIGIN_CALLER, address(token), address(revertingTarget), AMOUNT, gasHeavyPayload);
    // }
    ...
    // =========================
    //   ENHANCED ERC20 EXECUTION TESTS - REMOVED (CEA-only execution)
    // =========================
