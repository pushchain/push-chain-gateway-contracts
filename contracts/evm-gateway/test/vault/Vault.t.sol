...
contract VaultTest is Test {
    ...
    function test_ExecuteUniversalTx_OnlyTSSCanCall() public {
        ...
        vm.expectRevert();
        vault.finalizeUniversalTx(
            _tx(300), bytes32(uint256(3300)), user1, address(token), address(mockTarget), 100e18, data
        );
    }
    ...
    function test_ExecuteUniversalTx_ERC20_RevertsWhenPaused() public {
        ...
        vm.expectRevert();
        vault.finalizeUniversalTx(
            _tx(301), bytes32(uint256(3301)), user1, address(token), address(mockTarget), 100e18, data
        );
    }
    ...
    function test_ExecuteUniversalTx_Native_RevertsWhenPaused() public {
        ...
        vault.finalizeUniversalTx{ value: 1 ether }(
            _tx(302), bytes32(uint256(3302)), user1, address(0), address(mockTarget), 1 ether, data
        );
    }
    ...
    function test_ExecuteUniversalTx_ZeroOriginCallerReverts() public {
        ...
        vm.expectRevert(Errors.ZeroAddress.selector);
        vault.finalizeUniversalTx(
            _tx(303), bytes32(uint256(3303)), address(0), address(token), address(mockTarget), 100e18, data
        );
    }
    ...
    function test_ExecuteUniversalTx_Native_InvalidMsgValue_TooLow() public {
        ...
        vault.finalizeUniversalTx{ value: 0.5 ether }(
            _tx(305), bytes32(uint256(3305)), user1, address(0), address(mockTarget), 1 ether, data
        );
    }
    ...
    function test_ExecuteUniversalTx_Native_InvalidMsgValue_TooHigh() public {
        ...
        vault.finalizeUniversalTx{ value: 2 ether }(
            _tx(306), bytes32(uint256(3306)), user1, address(0), address(mockTarget), 1 ether, data
        );
    }
    ...
    function test_ExecuteUniversalTx_ERC20_NonZeroMsgValueReverts() public {
        ...
        vm.expectRevert(Errors.InvalidAmount.selector);
        vault.finalizeUniversalTx{ value: 1 ether }(
            _tx(307), bytes32(uint256(3307)), user1, address(token), address(mockTarget), 100e18, data
        );
    }
    ...
    function test_ExecuteUniversalTx_DeploysNewCEA_WhenNotExists() public {
        ...
        vm.prank(tss);
        vault.finalizeUniversalTx(
            _tx(308), bytes32(uint256(3308)), uea, address(token), address(mockTarget), 100e18, data
        );
    ...
    function test_ExecuteUniversalTx_ReusesExistingCEA() public {
        ...
        vm.prank(tss);
        vault.finalizeUniversalTx(
            _tx(309), bytes32(uint256(3309)), uea, address(token), address(mockTarget), 100e18, data
        );
        ...
        vm.prank(tss);
        vault.finalizeUniversalTx(
            _tx(310), bytes32(uint256(3310)), uea, address(token), address(mockTarget), 50e18, data
        );
    ...
    function test_ExecuteUniversalTx_CEAReceivesCorrectParameters_ERC20() public {
        ...
        vm.prank(tss);
        vault.finalizeUniversalTx(
            _tx(311), bytes32(uint256(3311)), uea, address(token), address(mockTarget), amount, data
        );

        (address cea,) = _getCEA(uea);
        _assertCEAParams(cea, _tx(311), bytes32(uint256(3311)), uea, data);
    }
    ...
    function test_ExecuteUniversalTx_CEAReceivesCorrectParameters_Native() public {
        ...
        vault.finalizeUniversalTx{ value: amount }(
            _tx(312), bytes32(uint256(3312)), uea, address(0), address(mockTarget), amount, data
        );

        (address cea,) = _getCEA(uea);
        _assertCEAParams(cea, _tx(312), bytes32(uint256(3312)), uea, data);
    }
    ...
    function test_ExecuteUniversalTx_ERC20_TransfersTokensToCEA() public {
        ...
        vm.prank(tss);
        vault.finalizeUniversalTx(
            _tx(313), bytes32(uint256(3313)), uea, address(token), address(mockTarget), amount, data
        );
    ...
    function test_ExecuteUniversalTx_ERC20_ReducesVaultBalance() public {
        ...
        vm.prank(tss);
        vault.finalizeUniversalTx(
            _tx(314), bytes32(uint256(3314)), uea, address(token), address(mockTarget), amount, data
        );
    ...
    function test_ExecuteUniversalTx_ERC20_CEAExecutesCall() public {
        ...
        vm.prank(tss);
        vault.finalizeUniversalTx(
            _tx(315), bytes32(uint256(3315)), uea, address(token), address(mockTarget), amount, data
        );
    ...
    function test_ExecuteUniversalTx_ERC20_UnsupportedTokenReverts() public {
        ...
        vm.expectRevert(Errors.NotSupported.selector);
        vault.finalizeUniversalTx(
            _tx(316), bytes32(uint256(3316)), user1, address(unsupportedToken), address(mockTarget), 100e18, data
        );
    }
    ...
    function test_ExecuteUniversalTx_ERC20_InsufficientVaultBalanceReverts() public {
        ...
        vm.expectRevert(Errors.InvalidAmount.selector);
        vault.finalizeUniversalTx(
            _tx(318), bytes32(uint256(3318)), user1, address(token), address(mockTarget), vaultBalance + 1, data
        );
    }
    ...
    function test_ExecuteUniversalTx_DifferentUEAs_GetDifferentCEAs() public {
        ...
        vm.prank(tss);
        vault.finalizeUniversalTx(
            _tx(320), bytes32(uint256(3320)), uea1, address(token), address(mockTarget), 50e18, data
        );

        vm.prank(tss);
        vault.finalizeUniversalTx(
            _tx(321), bytes32(uint256(3321)), uea2, address(token), address(mockTarget), 50e18, data
        );
    ...
    function test_ExecuteUniversalTx_ERC20_DifferentTokenTypes() public {
        ...
        vm.prank(tss);
        vault.finalizeUniversalTx(
            _tx(322), bytes32(uint256(3322)), uea, address(token), address(mockTarget), 100e18, data
        );

        // Test with 6-decimal token
        vm.prank(tss);
        vault.finalizeUniversalTx(
            _tx(323), bytes32(uint256(3323)), uea, address(token2), address(mockTarget), 50e6, data
        );
    ...
    function test_ExecuteUniversalTx_Native_ForwardsETHToCEA() public {
        ...
        vm.prank(tss);
        vault.finalizeUniversalTx{ value: amount }(
            _tx(324), bytes32(uint256(3324)), uea, address(0), address(mockTarget), amount, data
        );
    ...
    function test_ExecuteUniversalTx_Native_CEAExecutesCall() public {
        ...
        vm.prank(tss);
        vault.finalizeUniversalTx{ value: amount }(
            _tx(325), bytes32(uint256(3325)), uea, address(0), address(mockTarget), amount, data
        );
    ...
    function test_ExecuteUniversalTx_Native_DeploysNewCEA() public {
        ...
        vm.prank(tss);
        vault.finalizeUniversalTx{ value: amount }(
            _tx(326), bytes32(uint256(3326)), uea, address(0), address(mockTarget), amount, data
        );
    ...
    function test_ExecuteUniversalTx_Native_ReusesExistingCEA() public {
        ...
        vm.prank(tss);
        vault.finalizeUniversalTx{ value: amount }(
            _tx(327), bytes32(uint256(3327)), uea, address(0), address(mockTarget), amount, data
        );
        ...
        vm.prank(tss);
        vault.finalizeUniversalTx{ value: amount }(
            _tx(328), bytes32(uint256(3328)), uea, address(0), address(mockTarget), amount, data
        );
    ...
    function test_ExecuteUniversalTx_MixedFlows_ERC20ThenNative() public {
        ...
        vm.prank(tss);
        vault.finalizeUniversalTx(
            _tx(329), bytes32(uint256(3329)), uea, address(token), address(mockTarget), 100e18, data
        );
        ...
        vm.prank(tss);
        vault.finalizeUniversalTx{ value: 1 ether }(
            _tx(330), bytes32(uint256(3330)), uea, address(0), address(mockTarget), 1 ether, data
        );
    ...
    function test_ExecuteUniversalTx_FullWorkflow_ERC20() public {
        ...
        vm.prank(tss);
        vault.finalizeUniversalTx(
            _tx(331), bytes32(uint256(3331)), uea, address(token), address(mockTarget), amount, data
        );
    ...
    function test_ExecuteUniversalTx_FullWorkflow_Native() public {
        ...
        vm.prank(tss);
        vault.finalizeUniversalTx{ value: amount }(
            _tx(332), bytes32(uint256(3332)), uea, address(0), address(mockTarget), amount, data
        );
    ...
    function test_ExecuteUniversalTx_TargetReverts_ERC20() public {
        ...
        vm.expectRevert();
        vault.finalizeUniversalTx(
            _tx(333), bytes32(uint256(3333)), uea, address(token), address(mockRevertingTarget), amount, data
        );
    }
    ...
    function test_ExecuteUniversalTx_TargetReverts_Native() public {
        ...
        vm.expectRevert();
        vault.finalizeUniversalTx{ value: amount }(
            _tx(334), bytes32(uint256(3334)), uea, address(0), address(mockRevertingTarget), amount, data
        );
    }
    ...
    function test_ExecuteUniversalTx_ERC20_EmitsEvent() public {
        ...
        emit VaultUniversalTxFinalized(
            _tx(335), bytes32(uint256(3335)), uea, address(mockTarget), address(token), amount, data
        );

        vm.prank(tss);
        vault.finalizeUniversalTx(
            _tx(335), bytes32(uint256(3335)), uea, address(token), address(mockTarget), amount, data
        );
    }
    ...
    function test_ExecuteUniversalTx_Native_EmitsEvent() public {
        ...
        vm.expectEmit(true, true, true, true);
        emit VaultUniversalTxFinalized(
            _tx(336), bytes32(uint256(3336)), uea, address(mockTarget), address(0), amount, data
        );

        vm.prank(tss);
        vault.finalizeUniversalTx{ value: amount }(
            _tx(336), bytes32(uint256(3336)), uea, address(0), address(mockTarget), amount, data
        );
    }
    ...
    function test_ExecuteUniversalTx_EmitsEvent_WithEmptyPayload() public {
        ...
        vm.expectEmit(true, true, true, true);
        emit VaultUniversalTxFinalized(
            _tx(337), bytes32(uint256(3337)), uea, address(mockTarget), address(token), amount, data
        );

        vm.prank(tss);
        vault.finalizeUniversalTx(
            _tx(337), bytes32(uint256(3337)), uea, address(token), address(mockTarget), amount, data
        );
    }
    ...
    function test_ExecuteUniversalTx_EmitsEvent_WithComplexPayload() public {
        ...
        vm.expectEmit(true, true, true, true);
        emit VaultUniversalTxFinalized(
            _tx(338), bytes32(uint256(3338)), uea, address(mockTarget), address(token), amount, data
        );

        vm.prank(tss);
        vault.finalizeUniversalTx(
            _tx(338), bytes32(uint256(3338)), uea, address(token), address(mockTarget), amount, data
        );
    }
    ...
    function test_Withdraw_Native_MsgValueMismatch_TooLow() public {
        ...
        vm.expectRevert(Errors.InvalidAmount.selector);
        vault.finalizeUniversalTx{ value: 0.5 ether }(
            _tx(500), bytes32(uint256(3500)), user1, address(0), user1, 1 ether, _emptyMulticallPayload()
        );
    }
    ...
    function test_Withdraw_Native_MsgValueMismatch_TooHigh() public {
        ...
        vm.expectRevert(Errors.InvalidAmount.selector);
        vault.finalizeUniversalTx{ value: 2 ether }(
            _tx(501), bytes32(uint256(3501)), user1, address(0), user1, 1 ether, _emptyMulticallPayload()
        );
    }
    ...
    function test_Withdraw_ERC20_NonZeroMsgValueReverts() public {
        ...
        vm.expectRevert(Errors.InvalidAmount.selector);
        vault.finalizeUniversalTx{ value: 1 ether }(
            _tx(502), bytes32(uint256(3502)), user1, address(token), user1, 100e18, _emptyMulticallPayload()
        );
    }
    ...
    function test_Withdraw_NativeUnsupportedReverts() public {
        ...
        vm.expectRevert(Errors.NotSupported.selector);
        vault.finalizeUniversalTx{ value: 1 ether }(
            _tx(503), bytes32(uint256(3503)), user1, address(0), user1, 1 ether, _emptyMulticallPayload()
        );
    }
    ...
    function test_CEA_WithdrawThenExecute_ReusesSameCEA() public {
        ...
        vm.prank(tss);
        vault.finalizeUniversalTx(
            _tx(508), bytes32(uint256(3508)), uea, address(token), address(mockTarget), 50e18, data
        );
    ...
    function test_Execute_CallsCEAExecute_NotWithdrawTo() public {
        ...
        vm.prank(tss);
        vault.finalizeUniversalTx(
            _tx(510), bytes32(uint256(3510)), uea, address(token), address(mockTarget), 100e18, data
        );
    ...
    function test_Reentrancy_ExecutePath_Blocked() public {
        ...
        vm.prank(tss);
        vault.finalizeUniversalTx(
            _tx(518), bytes32(uint256(3518)), uea, address(token), address(mockTarget), 50e18, data
        );
    ...
    function test_Multicall_MalformedPayloadReverts() public {
        ...
        vault.finalizeUniversalTx(
            _tx(605), bytes32(uint256(3605)), uea, address(token), address(mockTarget), amount, malformedPayload
        );
    }
